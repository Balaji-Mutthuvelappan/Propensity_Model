...
#User_inputs
input_path = 'S://Beauty_Data//Virtual_Environments//Propensity_Model//'
output_path = r'S://Beauty_Data//Virtual_Environments//Propensity_Model//'
...
no_of_recommendations_final_model  = 5 # how many recommendations you want it from the final model

#Retrain dates contrains the list of dates the model will be trained
...
log_file = os.path.join(output_path, 'propensity_pipeline_final.log')
logging.basicConfig(
       ...
       # Drop completely empty rows
        ...
        for index, row in user_inputs.iterrows():
            ...
            if today_date in retrain_dates:
                ...
                columns_to_clean = ['Recommendation_1', 'Recommendation_2', 'Recommendation_3', 'Recommendation_4', 'Recommendation_5']
